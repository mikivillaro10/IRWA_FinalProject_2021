...
class SearchEngine:
    ...
    def search(self, search_query, tweets, search_id, corpus, index, tweet2vec, model):
        ...
        results = search_in_corpus(search_query, tweets, search_id, corpus, index, tweet2vec, model)
        ##### your code here #####
